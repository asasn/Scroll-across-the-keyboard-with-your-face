    ...
    public partial class HansWindow : Window
    {
        ...
        string GetBaikePage(string htmltext)
        {
            ...
            if (matches2.Count > 0)
            {
                ...
                {
                    matchTemp += WebHelper.GetHtmlText(match.Value);
                }
        ...
        {
            string html1 = WebHelper.GetHtmlText(urlStr);
            string html2;
            ...
            if (html1.Contains("lemmaWgt-subLemmaListTitle"))
            {
                ...
                html2 = WebHelper.GetHtmlText(url2);
        ...
        private void TbHans_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
