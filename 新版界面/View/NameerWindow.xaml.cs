...
namespace RootNS.View
{
    ...
    /// </summary>
    public partial class NameerWindow : Window
    {
        public NameerWindow()
        {
            InitializeComponent();
        ...
        {
            DirectoryInfo theFolder = new DirectoryInfo(Gval.Path.Assets + "/语料/取名工具/" + styleName + "/" + wpBank.Tag.ToString());
        ...
        private void Tb_GotFocus(object sender, RoutedEventArgs e)
        {
            ...
            foreach (char c in tb.Text)
            {
                ...
                else
                {
                    ...
                    string htmlText = WebHelper.GetHtmlText(urlStr);
        ...
        {
            string filepath = Gval.Path.Assets + "/语料/拼音字典/PinyinDict.txt";
            String line;
