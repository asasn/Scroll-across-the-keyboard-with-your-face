...
namespace 脸滚键盘.自定义控件
{
    ...
    /// </summary>
    public partial class UcontrolTreeBook : UserControl
    {
        #region 构造函数和载入方法
        public UcontrolTreeBook()
        {
            InitializeComponent();
        }
        ...
        public static readonly DependencyProperty UcTitleProperty =
            DependencyProperty.Register("UcTitle", typeof(string), typeof(UcontrolTreeBook), new PropertyMetadata(string.Empty));
        ...
        public static readonly DependencyProperty TreeViewNodeListProperty =
            DependencyProperty.Register("TreeViewNodeList", typeof(ObservableCollection<TreeViewNode>), typeof(UcontrolTreeBook), new PropertyMetadata(new ObservableCollection<TreeViewNode>()));
        ...
        public static readonly DependencyProperty TopNodeProperty =
            DependencyProperty.Register("TopNode", typeof(TreeViewNode), typeof(UcontrolTreeBook), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty CurNodeProperty =
            DependencyProperty.Register("CurNode", typeof(TreeViewNode), typeof(UcontrolTreeBook), new PropertyMetadata(null));
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (TypeOfTree == "book")
                        {
                            ...
                            UcontrolEditor ucEditor = new UcontrolEditor
                            {
