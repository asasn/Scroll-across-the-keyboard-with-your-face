...
namespace 脸滚键盘.自定义控件
{
    ...
    /// </summary>
    public partial class UTreeBook : UserControl
    {
        #region 构造函数和载入方法
        public UTreeBook()
        {
        ...
        public static readonly DependencyProperty UcTitleProperty =
            DependencyProperty.Register("UcTitle", typeof(string), typeof(UTreeBook), new PropertyMetadata(string.Empty));
        ...
        public static readonly DependencyProperty TreeViewNodeListProperty =
            DependencyProperty.Register("TreeViewNodeList", typeof(ObservableCollection<TreeViewNode>), typeof(UTreeBook), new PropertyMetadata(new ObservableCollection<TreeViewNode>()));
        ...
        public static readonly DependencyProperty TopNodeProperty =
            DependencyProperty.Register("TopNode", typeof(TreeViewNode), typeof(UTreeBook), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty CurNodeProperty =
            DependencyProperty.Register("CurNode", typeof(TreeViewNode), typeof(UTreeBook), new PropertyMetadata(null));
