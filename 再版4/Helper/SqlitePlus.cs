...
{
    public class SqlitePlus
    {

        public SqlitePlus(string dbFullPath, string dbName = null)
        {
            Close();
            connection = CreateDatabaseConnection(dbFullPath, dbName);
        ...
        public static Dictionary<string, SqlitePlus> PoolDict { get; set; } = new Dictionary<string, SqlitePlus>();
        ...
        public struct PoolOperate
        {
            ...
            public static void Add(string dbName)
            {
                ...
                {
                    PoolDict.Add(dbName, new SqlitePlus(Gval.Path.Books, dbName + ".db"));
                }
            }
